      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="flex flex-col justify-end gap-6 px-4 py-10 @[480px]:gap-8 @[480px]:px-10 @[480px]:py-20 text-center rounded-lg">
          <div className="flex flex-col gap-4">
            <h1 className="text-4xl text-black font-bold leading-tight tracking-[-0.033em] @[480px]:text-5xl font-display max-w-2xl mx-auto">Ready to find your perfect scent?</h1>
          ...
          <div className="flex justify-center">
            <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-[#e8308c] text-white text-base font-bold leading-normal tracking-[0.015em]"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 flex min-w-[100px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-[#e8308c] text-white text-base font-bold leading-normal tracking-[0.015em]"
              >
